...
// Load GraphQL query from external file (bundled at build time)
const GET_ENRICHED_PRODUCTS_QUERY = fs.readFileSync(
  path.join(__dirname, '../mesh/queries/get-enriched-products.gql'),
  'utf8'
);
